    ...
    if (len(words) == 2):
        ...
        if (verb == "go"):
            ...
            for i in range(len(Game.currentRoom.exits)):
                ...
                if (noun == Game.currentRoom.exits[noun]):

                    if Game.currentRoom.exitsL[noun] == "True":
